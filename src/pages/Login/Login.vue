      ...
      <div class="login_content">
        <form>
          ...
          <div :class="{on: !show}">
            <section>
              <section class="login_message">
                <input type="tel" placeholder="手机/邮箱/用户名" v-model="form.email">   
              </section>
              <section class="login_verification">
                <input type="tel" maxlength="8" placeholder="密码" v-model="form.password">
        ...
        <div class="register_btn_group">
          ...
          <a href="javascript:;" class="gray_color" @click="$router.push('/register')">注册</a>
        </div>
